...
function page() {
  return (
    <>
      ...
      <div
        className="box-shadow my-12 shodow-2xl flex justify-between mx-auto  bg-gray-100"
        style={{
          width: "70% ",
          boxShadow:
      ...
      >
        <div className="left-div w-2/5  py-12 px-8   ">
          <h1 className="text-primary-green text-2xl font-semibold">
            Coarse Enroll now
          </h1>
          <p className="text-gray-600 font-semibold my-1">
            Please fill all the fields for enroll in required coarse.
          </p>
          <div className="my-8">
            <form>
              ...
              <button className="bg-primary-green text-white font-semibold py-2 px-4 rounded-sm mt-2">
                SUBMIT
              </button>
            </form>
          </div>
